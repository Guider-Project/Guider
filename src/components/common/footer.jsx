...
export default function Footer() {
  return (
    <>
      <footer className="text-white py-5 pt-10 px-24 w-full bg-gray-900">
        <div className="w-full p-4 py-6">
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-24 pr-10">
              <div>
                <h2 className="mb-4 text-sm font-semibold text-white uppercase">Pages</h2>
                <ul className="text-gray-400 font-medium">
                  ...
                  <li className="mb-2">
                    <Link href="/complains" className="hover:underline">
                      Complains & Inquiries
                    </Link>
                  </li>
                  <li>
          ...
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-500">© 2023 Guider™. All Rights Reserved.</span>
